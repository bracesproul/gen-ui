...
export function FilterButton(props: FilterButtonProps): JSX.Element {
  return (
    <div className="p-4 min-w-[100px] rounded-md border-[0.5px] border-gray-400 flex flex-row items-start justify-center gap-[2px]">
      <p className="font-medium">{props.filterKey}:</p>
      <p className="font-normal text-gray-800">{props.filterValue}:</p>
    </div>
  );
}
